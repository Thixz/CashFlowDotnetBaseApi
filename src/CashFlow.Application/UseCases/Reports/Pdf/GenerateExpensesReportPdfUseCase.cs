...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private const int HEIGH_ROW_EXPENSE_TABLE = 25;
    ...
    {
        var expenses = await _repository.GetByFilteringMonth(month);
        ...
        foreach (var expense in expenses)
        {
            ...
            row.Height = HEIGH_ROW_EXPENSE_TABLE;
            ...
            if (string.IsNullOrWhiteSpace(expense.Description) == false)
            {
                ...
                descriptionRow.Height = HEIGH_ROW_EXPENSE_TABLE;
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Thiken Costa";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var directoryName = assembly.Location;

        row.Cells[0].AddImage(Path.Combine(directoryName, "Logo", "kilua.jpg"));

        row.Cells[1].AddParagraph("Olá, bebeninho!");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalAmount)
    {
        ...
        paragraph.AddFormattedText($"{totalAmount} {CURRENCY_SYMBOL}", new Font
        {
